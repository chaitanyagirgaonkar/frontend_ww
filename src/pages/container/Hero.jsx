...
export const Hero = () => {
    ...
    return (
        <section className="lg:mt-5 lg:ml-16 container mx-auto flex flex-col-reverse lg:px-10 px-4 py-5 lg:flex-row overflow-x-hidden">
            <div className="mt-24 lg:w-1/2">
                ...
                <p className="text-dark-light mt-6 text-center md:text-xl lg:text-base xl:text-xl lg:text-left lg:max-w-[500px]">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                    eiusmod tempor incididunt ut labore et dolore magna aliquaeiusmod
                    tempor incididunt ut labore et dolore magna aliquaeiusmod tempor
